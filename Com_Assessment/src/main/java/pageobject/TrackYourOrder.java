...
import uistore.TrackyourDetails;
	...
	public static Logger log=Logger.getLogger(ReadPropertyFile.class.getName());
		...
		@Test
		public void  TrackYourOrderTest() throws InterruptedException {
			...
			TrackyourDetails td = new TrackyourDetails(driver);
		    ...
		    td.getEmail().sendKeys("sri4321@gmail.com");
