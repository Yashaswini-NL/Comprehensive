...
public class SigninExcelDetails {
	
	public static HashMap<String,String> getTestData() throws IOException {
		
		FileInputStream fis = new FileInputStream("C:\\Users\\N L Yashaswini\\Downloads\\Com_Assessment\\Com_Assessment\\ExcelSheet\\Book12.xlsx");
	...
	public SigninExcelDetails(WebDriver driver) {
